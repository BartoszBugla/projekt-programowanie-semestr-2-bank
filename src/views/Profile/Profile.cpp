...
void Profile::currencies() {
    ...
    for (int i = 0; i < 40; i++) cout << color("*", Color::magenta);
    cout<<endl;
    cout<<balance<<color("(PLN)",Color::green)<<" = "<<setprecision(5)<<euro<<color("(EUR)",Color::blue)<<endl;
    cout<<balance<<color("(PLN)",Color::green)<<" = "<<setprecision(5)<<dolar<<color("(USD)",Color::blue)<<endl;
    cout<<balance<<color("(PLN)",Color::green)<<" = "<<setprecision(5)<<funt<<color("(GBP)",Color::blue)<<endl;
    for (int i = 0; i < 40; i++) cout << color("*", Color::magenta);
    cout<<endl;
    cout<<"1.Powrot"<<endl;
    cout<<endl;
